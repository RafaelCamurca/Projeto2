...
<body class="text-center"> 
  <main class="form-signin w-100 m-auto">
      ...
      <br>
      <div class="form">
        <form action="../../php/secretaria/cadastromembro.php" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate style="width: 1200px; padding-left: 17rem;">
            <nav class="navbar bg-dark" data-bs-theme="dark" style="text-align: center;">
                <h3 style="padding-left: 20rem;">Cadastro de Membro</h3>
            </nav>
            <div class="col-md-2">
            ...
            <div class="col-md-6">
                ...
                <input id="nome" maxlength="50" type="text" class="form-control" name="nome" autofocus required>
            </div>
            <div class="col-md-4">
                <label for="pertencea" class="form-label">Igreja</label>
                <select id="pertencea" class="form-select" name="pertencea" required>
            ...
            <div class="col-md-3">
                ...
                <input id="telefone" maxlength="15" type="text" class="form-control" name="telefone" placeholder="(99) 99999-9999" required>
            </div>
            <div class="col-md-5">
                <label for="email" class="form-label">E-mail</label>
                <input id="email" maxlength="50" type="text" class="form-control" name="email" aria-describedby="inputGroupPrepend" placeholder="example@example.com" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                ...
                <input id="cep" type="text" class="form-control" name="cep" placeholder="ex: 00000-000" required>
            </div>
            <div class="col-md-5">
            ...
            <div class="col-md-3">
                ...
                <input id="databatismo" type="date" class="form-control" name="databatismo">
            </div>
            <div class="col-md-3">
                <label for="membrodesde" class="form-label">Membro Desde</label>
                <input id="membrodesde" type="date" class="form-control" name="membrodesde">
            </div>
            <div class="col-md-3">
                <label for="aceitoujesus" class="form-label">Aceitou a Jesus</label>
                <input id="aceitoujesus" type="date" class="form-control" name="aceitoujesus">
            </div>
            <div class="col-md-12">
                <label for="observacao">Observações</label>
                <textarea id="observacao" class="form-control" name="observacao" rows="3" style="width: 100%;"></textarea>
            </div>
            <?php
            ...
            ?>
            <div class="col-12">
                <button class="btn btn-primary" type="submit">Cadastrar Membro</button>
